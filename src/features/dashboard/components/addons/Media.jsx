...
export default function Media({ media, id, createdAddonId, setForm }) {
      ...
      <div className="row">
              ...
              {Array(3)
                ...
                .map((_, i) => (
                  <MediaUploadField
                    ...
                    itemId={id || Number(createdAddonId)}
                    itemType="ADDON"
                    mediaId={images?.[i]?.id}
                    labelIdle={`${
        ...
        <div className="col-12 p-2">
          <MediaUploadField
            ...
            handleFileUpload={(file) =>
              handleFileUpload(id || Number(createdAddonId), "ADDON", file)
            }
            handleRemoveMedia={handleRemoveMedia}
            itemId={id || Number(createdAddonId)}
            itemType="ADDON"
